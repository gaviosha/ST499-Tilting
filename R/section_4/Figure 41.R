########################################
# General screening analysis: R2 = 0.9 #
########################################
...
v =rnorm(n = 500, sd = sqrt(s))
e <- arima.sim(list(order=c(1,0,0), ar=.6), n=500, innov = v)
...
active.stable <- tilt.it.stable(X,y,20, thr = thr.for.all)
print(active.stable)
...
########################################
# General screening analysis: R2 = 0.6 #
########################################
...
########################################
# General screening analysis: R2 = 0.3 #
########################################
