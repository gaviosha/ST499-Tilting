#####################################################
# Heteroskedasticity (AR errors) analysis: R2 = 0.9 #
#####################################################
...
#####################################################
# Heteroskedasticity (AR errors) analysis: R2 = 0.6 #
#####################################################
...
b = rep(0,1000)
b[c(200,400,600,800,1000)] = c(1,-1,1,-1,1)
s = (t(b)%*%S%*%b/(1-0.4^2))*((1/0.6)-1)*(1-0.6^2)/5
...
#####################################################
# Heteroskedasticity (AR errors) analysis: R2 = 0.3 #
#####################################################
...
b = rep(0,1000)
b[c(200,400,600,800,1000)] = c(1,-1,1,-1,1)
s = (t(b)%*%S%*%b/(1-0.4^2))*((1/0.3)-1)*(1-0.6^2)/5
