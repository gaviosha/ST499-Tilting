...
X <- dat[1:82,-c(1,12)] # assign design matrix 
y <- dat[2:83,12] # assign target

set.seed(123) # set seed for random components
...
for (t in 1:32){
  ...
  to_choose <- c(59:61,107:109) # choose first three lags and three factors
